    ...
    <>
      <motion.div
        ...
        <motion.div
          ...
          className={` z-[1000] bg-white rounded-lg w-[450px] md:w-[480px] ${isOpen ? "h-[580px]" : "h-[550px]"} fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 overflow-hidden`}>
